...
export const config = {
	AUTHORIZATION_URL:
		process.env.AUTHORIZATION_URL === undefined ? '' : process.env.AUTHORIZATION_URL,
	...
	POST_LOGOUT_REDIRECT_URI:
		process.env.POST_LOGOUT_REDIRECT_URI === undefined ? '' : process.env.POST_LOGOUT_REDIRECT_URI,
